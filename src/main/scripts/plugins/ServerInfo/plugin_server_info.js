...
ServerInfo.prototype.setupHTML = function() {
...
ServerInfo.prototype.setupResData = function(parent, pid, user, cpuMem, command) {
...
ServerInfo.prototype.setExpandInfo = function(id, parent, key, value) {
